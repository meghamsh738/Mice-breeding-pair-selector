...
Modern React + FastAPI web app for pairing mouse breeders from colony spreadsheets. Use the bundled example dataset for a zero-upload demo or bring your own CSV/XLSX. The old PyQt desktop UI is archived in `LEGACY.md`.
...
- `modern-app/screenshots/example_run.png` – Latest UI snapshot (generated by E2E on Dec 25, 2025)
